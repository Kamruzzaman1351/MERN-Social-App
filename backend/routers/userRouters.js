...
const {sendFriendRequest, getAllFriends, approvedFriendRequest, getFriends} = require("../controllers/friendRequestController.js")
...
router.get("/allfriends", userProtect, getFriends)
